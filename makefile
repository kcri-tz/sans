...
## IF DEBUG
 CC = g++ -g -march=native -DmaxK=32 -DmaxN=64
...
SANS: main.o
	$(CC) -o SANS main.o graph.o kmer32.o kmerXX.o kmerAmino.o color64.o colorXX.o util.o $(BF)
	rm -rf obj/; mkdir obj/; mv *.o obj/

main.o: src/main.cpp src/main.h graph.o util.o
	$(CC) -c src/main.cpp

graph.o: src/graph.cpp src/graph.h kmer32.o kmerXX.o kmerAmino.o color64.o colorXX.o
	$(CC) -c src/graph.cpp
...
kmerAmino.o: src/kmerAmino.cpp src/kmerAmino.h
